...
// ── 2. NOTES depuis la table notes (avec nom du cours)
...
<body>
  ...
  <nav>
    ...
    <div class="nav-links">
      ...
      <a href="messagerie_etudiant.html">Messagerie</a>
  ...
  <main class="dashboard-wrapper">
    ...
    <div class="main-col">
      ...
      <div class="kpi-container">
        ...
        <div class="glass-panel kpi-card">
          <div class="kpi-title">Promotion</div>
          <div class="kpi-value" style="font-size:1.6rem"><?= htmlspecialchars($etudiant['promo'] ?? '—') ?></div>
          <div class="kpi-sub"><?= htmlspecialchars($etudiant['classe'] ?? '') ?></div>
        </div>
      </div>
      ...
      <div class="card-container">
        ...
        <div class="glass-panel std-card">
          ...
          <?php else: ?>
            ...
            <?php endforeach; ?>
          <?php endif; ?>
          <a href="messagerie_etudiant.html" class="msg-btn">Accéder à la messagerie</a>
        </div>
    ...
    <div class="side-col">
      ...
      <div class="glass-panel std-card">
        ...
        <div style="display:flex;flex-direction:column;gap:0.8rem;">
          <a href="messagerie_etudiant.html" class="action-btn">Envoyer un message</a>
