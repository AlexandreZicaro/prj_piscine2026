      ...
      <div class="card-container">
        ...
        <div>
          ...
          <div class="actions-grid">
            ...
            <a href="gestion_enseignant.php" class="action-btn">Rechercher enseignant</a>
            <a href="gestion_etudiant.php" class="action-btn">Rechercher étudiant</a>
          </div>
        </div>
        ...
        <div class="glass-panel std-card">
          ...
          <a href="messagerie_admin.php" class="msg-btn">Accéder à la messagerie globale</a>
        </div>
